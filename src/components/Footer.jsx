...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-white text-black p-20 font-['Founders_grotesk_X-Condensed']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[10vw] font-semibold uppercase leading-none -mb-5">
            Eye-
          </h1>
          <h1 className="text-[10vw] font-semibold uppercase leading-none ">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[9.5vw]  font-semibold uppercase leading-none ">
          Presentations
        </h1>
        <div className="dets font-['Neue_Montreal']">
          <p className="mb-4">S: </p>
          <a className="underline block text-xlfont-light" href="#">
            Facebook
          </a>
          <a className="underline block text-xlfont-light" href="#">
            Instagram
        ...
        <div className="dets font-['Neue_Montreal'] mt-8">
          ...
          <a className="underline block text-xlfont-light mb-4" href="#">
            Vancouver, Canada
          </a>
          <a className="underline block text-xlfont-light" href="#">
            30 Chukarina St
